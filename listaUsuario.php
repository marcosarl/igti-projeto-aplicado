...
<br>
        <tr>  
       <td colspan="6" >   TOTAL DE REGISTROS:  <?= $total  ?> <br><br><strong>Admin:</strong> Acesso total<br>
<strong>Conselho:</strong> Cadastro, edição e pesquisa<br>
<strong>Membros:</strong> Pesquisa</td>
       </tr>
</tbody>
</table>
